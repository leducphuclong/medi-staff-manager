...
public class XemNhanVienFX extends Application {
    ...
    private void setupTableView() {
        ...
        TableColumn<NhanVien, String> hoTenColumn = new TableColumn<>("Tên");
        hoTenColumn.setCellValueFactory(param -> new SimpleStringProperty(param.getValue().getHoTen()));

        // Add other columns similarly...

        tableView.getColumns().addAll(selectColumn, idColumn, cccdColumn, hoTenColumn);
    }
    ...
    private void chuyenPhongBan() {
        // Logic for transferring employees...
    }
