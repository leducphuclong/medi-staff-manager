...
public class SwingInFxExample2 extends Application {
    ...
    public void displaySwingPanel(Stage primaryStage) {
        ...
        SwingUtilities.invokeLater(() -> {
            JPanel swingPanel = TrangChinhLichThang.createMainPanel(); // Create our custom JPanel
        ...
        Scene scene = new Scene(root, TrangChinhLichThang.PARENT_WIDTH, TrangChinhLichThang.PARENT_HEIGHT+100); // Adjusted size for this example
