...
public class QuanLyLuongBridge2 {
    ...
    public String layLuongTheoThang(String thangNam) {
        ...
        List<LuongNhanVienBEAN> list = luongNhanVienController.layLuongTheoThang(thangNam);
        StringBuilder sb = new StringBuilder("[");
        if (list != null) {
            for (int i = 0; i < list.size(); i++) {
                LuongNhanVienBEAN l = list.get(i);
                sb.append("{")
    ...
    public String timKiemLuongTheoIDNhanVien(int idNhanVien) {
        ...
        try {
            List<LuongNhanVienBEAN> danhSach = luongNhanVienController.timKiemLuongTheoIDNhanVien(idNhanVien);
    ...
    public String timKiemLuongTheoChucVu(int idChucVu) {
        ...
        try {
            ...
            List<LuongNhanVienBEAN> danhSach = luongNhanVienController.timKiemLuongTheoChucVu(idChucVu);
            // Chuyển về JSON
            String jsonData = convertLuongNhanVienListToJson(danhSach);
            return jsonData;
        } catch (Exception e) {
    ...
    public void themLuong(int idChucVu, int idNhanVien, String thangNam,
        ...
        try {
            ...
            LuongNhanVienBEAN lnv = new LuongNhanVienBEAN(0, idChucVu, idNhanVien, thangNam,
    ...
    public void capNhatLuong(int idLuong, int idChucVu, int idNhanVien, String thangNam,
			...
			LuongNhanVienBEAN luong = new LuongNhanVienBEAN(idLuong, idChucVu, idNhanVien, thangNam,
    ...
    private String convertLuongNhanVienListToJson(List<LuongNhanVienBEAN> danhSach) {
        if (danhSach == null) {
            return "[]";
        }
        StringBuilder jsonBuilder = new StringBuilder("[");
        for (int i = 0; i < danhSach.size(); i++) {
            LuongNhanVienBEAN lnv = danhSach.get(i);
            String hoTen = "";
            try {
