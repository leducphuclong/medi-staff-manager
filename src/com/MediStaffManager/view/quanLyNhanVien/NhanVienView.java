...
public class NhanVienView extends Application {
    ...
    private NhanVienBridge nhanVienBridge;

    // Bỏ biến initialPage ở đây, việc load sẽ do NhanVienBridge xử lý
    // final String initialPage = "./src/com/MediStaffManager/view/quanLyNhanVien/trang_quan_ly_nhan_vien.html";

    @Override
    public void start(Stage primaryStage) {
        NhanVienController nhanVienController = new NhanVienController();
        // Truyền 'this' (NhanVienView instance) cho NhanVienBridge
        nhanVienBridge = new NhanVienBridge(nhanVienController, this);
